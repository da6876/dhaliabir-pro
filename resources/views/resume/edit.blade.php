...
@section('page-title', 'Edit Resume Entry')
        ...
        <form id="editForm" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="10"
                          class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2
                           focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm">{!! $resume->description !!}</textarea>
            </div>
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('resume.index') }}" class="text-gray-600 hover:text-gray-800 text-sm font-medium">Cancel</a>
            </div>
        </form>
    </div>
@endsection
...
@push('scripts')
    ...
    <script>
        ...
        $('#editForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('resume.update', $resume->id) }}",
