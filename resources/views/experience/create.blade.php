    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <form id="experienceForm" class="space-y-6">
            ...
            <div class="flex items-center gap-4 mt-6">
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-md text-sm">Save</button>
    ...
    <script>
        ...
        function updateHidden(container, hiddenInput) {
            ...
            $(container).children('span').each(function() {
                values.push($(this).text().slice(0, -2).trim()); // remove &times;
            });
